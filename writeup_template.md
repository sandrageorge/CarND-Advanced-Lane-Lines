...
I used a combination of color and gradient thresholds to generate a binary image (thresholding steps at lines 43 through 78 in `advancedLines.py`).  Here's an example of my output for this step.  (note: this is not actually from one of the test images)
...
I did this in lines 271 through 288 in my code in `my_other_file.py`
